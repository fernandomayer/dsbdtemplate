...
\instituicao{Universidade Federal do Paraná
             \par
             Especialização em Data Science \& Big Data
             % \par
...
\preambulo{Projeto de Pesquisa apresentado ao curso de Especialização em
  Data Science \& Big Data da Universidade Federal do Paraná, como requisito para elaboração do Trabalho de Conclusão de Curso.}
